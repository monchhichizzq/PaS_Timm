...
# https://github.com/huggingface/pytorch-image-models/discussions/1106
# https://github.com/huggingface/pytorch-image-models/discussions/924
...
group.add_argument('--model', default=net_arch, type=str, metavar='MODEL',
...
group.add_argument('--img-size', type=int, default=img_size, metavar='N',
                   help='Image size (default: None => model default)')
group.add_argument('--img-size-eval', type=int, default=img_size_eval, metavar='N',
                   help='Image size (default: None => model default)')
...
group.add_argument('--output', default=save_dir, type=str, metavar='PATH',
...
def main():
    ...
    try:
        for epoch in range(start_epoch, num_epochs):
            ...
            converge_path = os.path.join(output_dir, f"convergence_{prune_ratio}_pmacs_{prune_macs}_tmacs_{target_macs}.pt")
